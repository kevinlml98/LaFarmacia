...
namespace LaFarmacia.Models.viewModel
{
    ...
    public partial class LaFarmaciaDBEntities3 : DbContext
    {
        public LaFarmaciaDBEntities3()
            : base("name=LaFarmaciaDBEntities3")
        {
        }
        ...
        public virtual DbSet<SP_CheckUser_Result> T_User { get; set; }
